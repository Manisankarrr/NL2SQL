...
async def build_prompt(
    ...
    user_message = (
        ...
        f"Date: {entities.date if entities.date else 'not specified'}\n"
        f"Time: {entities.time if entities.time else 'not specified'}\n"
        f"Customer: {entities.customer_name if entities.customer_name else 'not specified'}\n"
        f"Status: {entities.status if entities.status else 'not specified'}\n"
